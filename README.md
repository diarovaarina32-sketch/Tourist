...
1. **Временной охват**: Данные охватывают 45-летний период с 1979 по 2024 год, что позволяет анализировать долгосрочные тренды в туристической отрасли Новой Зеландии.

2. **Ключевые страны**: Основными источниками туристов являются Австралия, Китай, США, Великобритания, Япония и Германия.

3. **Корреляционные связи**:
   - Сильная положительная корреляция между Holiday Visitors и Total Visitor Spend
   - Отрицательная корреляция между длиной пребывания и тратами в день
   - Прямая зависимость между количеством туристов и общими тратами

4. **Особенности данных**:
   - Данные по тратам (Spend Per Day) доступны только с 1999 года
   - Разные страны демонстрируют различные паттерны в длительности пребывания и ежедневных тратах
